      ...
      {createPortal(
        ...
        >
          <div
            ...
            onClick={() => close()}
          ></div>
          <div className='max-w-lg w-full flex flex-col gap-3 items-center bg-white z-2 p-4 mx-auto rounded-2xl'>
            <div className='w-8 h-1 bg-gray-300 rounded-xs mb-2'></div>
            {children}
          </div>
        </div>,
        document.body,
